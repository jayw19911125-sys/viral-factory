...
INDUSTRY_LIST = [
    ...
    {"name": "彩妝美髮",   "keywords": ["彩妝", "口紅", "染髮", "美甲", "睫毛"]},
    {"name": "醫美診所",   "keywords": ["醫美", "雷射", "微整", "玻尿酸", "縮毛孔"]},
    # ── 健康醫療 ──
    {"name": "健身減重",   "keywords": ["健身", "瘦身", "減脂", "增肌", "運動"]},
    {"name": "保健食品",   "keywords": ["保健", "益生菌", "膠原蛋白", "維他命", "補充品"]},
    {"name": "中醫診所",   "keywords": ["中醫", "針灸", "調理", "體質", "漢方"]},
    {"name": "牙科診所",   "keywords": ["牙科", "矯正", "植牙", "洗牙", "牙齒美白"]},
    # ── 飲食餐飲 ──
    {"name": "餐飲食品",   "keywords": ["餐廳", "美食", "便當", "飲料", "甜點"]},
    {"name": "烘焙甜點",   "keywords": ["烘焙", "蛋糕", "麵包", "甜點", "手工餅乾"]},
    {"name": "機能飲品",   "keywords": ["咖啡", "茶飲", "果汁", "能量飲", "手搖"]},
    # ── 服飾生活 ──
    ...
    {"name": "語言學習",   "keywords": ["英文", "日文", "韓文", "語言", "外語學習"]},
    {"name": "親子教育",   "keywords": ["親子", "育兒", "幼兒", "補習", "才藝"]},
    {"name": "職涯發展",   "keywords": ["求職", "履歷", "面試", "轉職", "職場技能"]},
    # ── 財務金融 ──
    {"name": "投資理財",   "keywords": ["投資", "股票", "基金", "理財", "被動收入"]},
    {"name": "保險金融",   "keywords": ["保險", "壽險", "醫療險", "儲蓄險", "信貸"]},
    # ── 科技數位 ──
    {"name": "3C電子",     "keywords": ["手機", "筆電", "耳機", "平板", "智慧家電"]},
    {"name": "軟體服務",   "keywords": ["APP", "軟體", "訂閱", "SaaS", "數位工具"]},
    {"name": "AI工具",     "keywords": ["AI", "人工智慧", "ChatGPT", "自動化", "AI工具"]},
    # ── 旅遊娛樂 ──
    {"name": "旅遊住宿",   "keywords": ["旅遊", "飯店", "民宿", "出國", "訂房"]},
    {"name": "娛樂展演",   "keywords": ["演唱會", "展覽", "電影", "遊樂園", "活動"]},
    # ── 不動產交通 ──
